  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 p-6 md:px-12 bg-transparent text-gray-800">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold font-serif tracking-widest text-shadow-gray-700 drop-shadow-lg">FOOD EAT</h1>
        
        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
          {navItems.map((item) => (
            <a key={item.name} href="#" className="uppercase text-gray-700 hover:text-orange-400 transition duration-300 relative group">
              {item.name}
